    ...
    choice: [
      {
        ...
        target: 'start',
        explaination:
          'Il saisit fermement la bouteille de whisky. Lucas : “Cul sec ou rien.” Noémie : “Ça part.” L’alcool glisse comme papa dans maman.',
      },
      {
        text: 'Coca Cola',
        target: 'start',
        explaination:
          'Lucas : “Coca bien frais chakal!” Face à cette référence hasardeuse, Noémie reste de marbre, mais accepte néanmoins le verre.',
      },
    ],
  },
  // ============================================================================
  {
    ...
    choice: [
      ...
      },
      {
        ...
        target: 'back_home',
        explaination:
          'Lucas : “Je suis désolé Noémie mais je préfère pas qu’on le fasse tout de suite” Noémie : “Il n’y a pas de problème, ne t’en fais pas”',
      },
    ],
  },
  // ============================================================================
    ...
    choice: [
      {
        ...
        target: 'without',
        explaination:
          'Lucas : “Non je n’en ai pas sur moi mais ce n’est pas grave, je me retirerais avant” Noémie : “Okay je te fais confiance”',
      },
      {
        text: 'Lucas va demander à un de ses amis de la soirée s’il en a pas un à lui donner.',
        target: 'ask',
        explaination:
          'Lucas : “Je n’en ai pas sur moi mais je vais aller demander à un ami. Ne bouge pas, je reviens vite”',
      },
    ],
  },
  // ============================================================================
  ...
  // ============================================================================
  {
    ...
    choice: [
      ...
      },
      {
        ...
        target: 'stop',
        explaination:
          'Lucas : “Le préservatif me serre trop, je préfère qu’on remette ça à plus tard ” Noémie : "Oui pas de problème, on aura d\'autres occasions de se revoir',
      },
    ],
  },
  // ============================================================================
